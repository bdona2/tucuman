...
var style_HectreasdehortalizasINDEC_10 = function(feature, resolution){
    ...
    var value = feature.get("Hortaliza");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 0.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 80.000000 && value <= 225.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 225.000000 && value <= 575.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 575.000000 && value <= 1256.100000) {
            style = [ new ol.style.Style({
